#𝐀𝐧𝐭𝐚𝐫𝐞𝐬[𝐃𝐨𝐥𝐥𝐲] 𝙋.𝙆_𝘽𝙊𝙏𝙎 update 02-12-2020
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                               dollypk.sendMessage(msg.to, "       𝙋.𝙆 𝙎𝙀𝙇𝙁𝘽𝙊𝙏𝙎 \n▪Protect Bots\n▪Version Lupa\n▪Team=𝙋.𝙆 𝙏𝙀𝘼𝙈𝘽𝙊𝙏𝙎\n▪Creator=𝐀𝐧𝐭𝐚𝐫𝐞𝐬[𝐃𝐨𝐥𝐥𝐲]\n\n       Supported by:\n•Aki Devan\n•Ben \n•IGO \n•ELFOX\n•𝐁𝐓𝐑 𝐟𝐚𝐦𝐢𝐥𝐲 Ibal & Friend\n•°™ᴀʟɪᴘ•GRIND KILLER\n•☆𝕱𝖆𝖒𝖟 𝖐𝖊𝖇𝖔𝖙𝖆𝖓☆\n\n         𝙋.𝙆_𝘽𝙊𝙏𝙎  2020\n")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               dollypk.sendMessage(msg.to, "「Mykey」\nSetkey bot mu「 " + str(Setmain["keyCommand"]) + " 」")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               if key in [""," ","\n",None]:
                                   ...
                                   dollypk.sendMessage(msg.to, "「Setkey」\nSetkey diganti jadi「{}」".format(str(key).lower()))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               dollypk.sendMessage(msg.to, "▪Sabar nyet agak lama\nBot receh soal nya")
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                dollypk.sendMessage(msg.to, "「 𝐏.𝐊°𝐁𝐎𝐓𝐒ᴾʳᵒᵗᵉᶜᵗ 」Grup Info\n\nNama Group : {}".format(G.name)+ "\n▪ID Group : {}".format(G.id)+ "\n▪Pembuat : {}".format(G.creator.displayName)+ "\n▪Waktu Dibuat : {}".format(str(timeCreated))+ "\n▪Jumlah Member : {}".format(str(len(G.members)))+ "\n▪Jumlah Pending : {}".format(gPending)+ "\n▪Group Qr : {}".format(gQr)+ "\n▪Group Ticket : {}".format(gTicket))
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                timeCreated = []
                                timeCreated.append(time.strftime("%d-%m-%Y [ %H:%M:%S ]", time.localtime(int(G.createdTime) / 1000)))
                                ret_ += "▪「 𝐏.𝐊°𝐁𝐎𝐓𝐒ᴾʳᵒᵗᵉᶜᵗ」 Grup Info\n"
                                ret_ += "\n▪Nama Group : {}".format(G.name)
                                ret_ += "\n▪ID Group : {}".format(G.id)
                          ...
                          if msg._from in admin:
                            ...
                            for i in group:
                                ...
                                if ginfo == group:
                                    ...
                                    pk2.leaveGroup(i)
                                    pk3.leaveGroup(i)
                                    dollypk.sendMessage(msg.to,"▪Berhasil keluar di grup " +str(ginfo.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               dollypk.sendMessage(msg.to,"╔══[ FRIEND LIST ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Friends ]")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               dollypk.sendMessage(msg.to,"╔══[ GROUP LIST ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                if msg.toType == 2:
                                   ...
                                   dollypk.updateGroup(X)
                                   dollypk.sendMessage(msg.to, "▪Url Opened")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if msg.toType == 2:
                                ...
                                dollypk.sendMessage(msg.to,"▪Kirim fotonya")
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                ...
                                pk.sendMessage(msg.to,"▪Kirim fotonya ")
                                
                        elif cmd == "pk2up":
                            if msg._from in admin:
                                Setmain["ARfoto"][Bmid] = True
                                pk2.sendMessage(msg.to,"▪Kirim fotonya ")
                                
                        elif cmd == "pk3up":
                            if msg._from in admin:
                                Setmain["ARfoto"][Cmid] = True
                                pk3.sendMessage(msg.to,"▪Kirim fotonya ")
                                
                        elif cmd == "jsup":
                            if msg._from in admin:
                                Setmain["ARfoto"][Zmid] = True
                                pkjs.sendMessage(msg.to,"▪Kirim fotonya ")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                dollypk.sendMessage(msg.to,"▪Nama diganti jadi " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                pk.sendMessage(msg.to,"▪Nama diganti jadi " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                pk2.sendMessage(msg.to,"▪Nama diganti jadi " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                pk3.sendMessage(msg.to,"▪Nama diganti jadi " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                pkjs.sendMessage(msg.to,"▪Nama diganti jadi " + string + "")
...
#==============CMD List============================#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                dollypk.sendMessage(msg.to,"▪「 𝐏.𝐊°𝐁𝐎𝐓𝐒ᴾʳᵒᵗᵉᶜᵗ」\n\n"+ma+"\nTotal「%s」 Bots" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                dollypk.sendMessage(msg.to,"▪List ADMIN \n\nSuper admin:\n"+ma+"\nAdmin:\n"+mb+"\nStaff:\n"+mc+"\nTotal「%s」「𝐏.𝐊°𝐁𝐎𝐓𝐒ᴾʳᵒᵗᵉᶜᵗ 」 " %(str(len(owner)+len(admin)+len(staff))))
...
#==============PROTECT===================
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ...
                                    dollypk.sendMessage(msg.to,"▪Grup "+str(ginfo.name)+"Kami amanin")
                                except:
                                    pass
                          ...
                          if wait["selfbot"] == True:
                        	...
                        	if msg._from in admin:
                                 start = time.time()
                                 dollypk.sendMessage(to, "▪Lumayan Buat mainan")
                          ...
                          if wait["selfbot"] == True:
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  ...
                                  dollypk.sendMessage(msg.to, "「Diaktifkan」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in welcome:
                                    ...
                                    dollypk.sendMessage(msg.to, "「Dinonaktifkan」\n" + msgs)
                            ...
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                ...
                                for m_id in wait["blacklist"]:
                                    ...
                                    ma += str(a) + ". " +dollypk.getContact(m_id).displayName + "\n"
                                dollypk.sendMessage(msg.to,"▪Blacklist User\n\n"+ma+"\nTotal「%s」Blacklist User" %(str(len(wait["blacklist"]))))
...
#===========COMMAND SET============#
                           ...
                           if msg._from in admin:
                      	  ...
                      	  if msg._from in admin:
                       	    dollypk.sendMessage(to,"          𝙋.𝙆 𝙎𝙀𝙇𝙁𝘽𝙊𝙏𝙎 \n   ▪Open Order▪\n\n🔹️VPS CONOHA NON RENEW\n2 Core 1GB = 100k \n3 Core 2GB =200k\n4 Core 4GB = 360k \n\n🔹️VPS CONOHA RENEW\n2 Core 1GB =120k\n3 Core 2GB = 240k\n4 Core 4GB = 420k \n\n🔹️VPS LINODE \n1 Core 2GB = 50k \n2 Core 4GB = 100K \n4 Core 8GB = 200K \n6 Core 16GB = 350K\n\n            ▪Open Order▪\n▪script Bot cl = 200K\n▪script Selfbot only =150k\n▪script Self Template=400K\n         ▪Open Sewa/Rental▪\n▪Sewa Pro Go= 300k/7 Bot\n▪Nambah asis Pc aja\n▪Sewa pro python= Harga pc\n▪Sewa Protect Cl Bot= 25K/Bot\n\n▪Pembuatan Bot kuis=30K/Bulan\nSoal,Nick Bot Atas nama kalian\n\n▪Jasa Protect=50k/Room\nMenggunakan Pro Go[Golang] \n\n▪Token primery 5k/token\n▪1 nomer 1 token\n▪ Juga open gift tikel ya mslah harga selalu berubah\n\nminat ? tanya2? chat id di bawah\nline.me/ti/p/~mina59.")
